      ...
      >
        <div className="max-w-wd form-lesson-container flex gap-10">
          <div>
            ...
            <p>
              <label htmlFor="file-url">Url da aula</label>
            </p>
            <input
              type="text"
              name="file_url"
            ...
            <button
              className="bg-cyan-400 hover:bg-skin-cl700 transition cursor-pointer text-white w-full"
              type="reset"
            >
              Limpar
            </button>
          ...
          <div className="flex flex-col">
            <p>
              <label htmlFor="subject">Selecione a Disciplina</label>
            </p>
            <select
            ...
            <div className="max-w-md flex flex-col">
              <p>
                <label htmlFor="file">Selecione a aula</label>
              </p>
              <input
              ...
              {blob && (
                <div className="max-w-md">
                  Link da Aula gerada:{" "}
                  <a className="text-cyan-700" href={blob.url}>
                    {blob.url}
                  </a>
                </div>
              )}
